import psycopg2
import uuid
from random import choice, randint, sample, uniform, choice
...
def generate_location_data():
    ...
    latitude = str(uniform(-90, 90))
    longitude = str(uniform(-180, 180))
    return (id, city, country, latitude, longitude)
