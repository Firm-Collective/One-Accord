...
def generate_user_data():
    ...
    location_ids = ['5d82cdd3-3f2f-47ff-a805-25e7151926d7', 'f1201b2c-b39b-4b20-8465-0b7898b159e9', 't458e7db-490b-49e4-a25e-25a6666fd30f']
    notification_ids = ['5d82cdd3-3c2f-47ff-a805-25e71519262q', 'b5901b2c-b39b-4b20-8465-0b7898b1592q', '2a78e7db-490b-49e4-a25e-25a6666fd32q']
...
def generate_post_data(user_ids):
    ...
    event_ids = ['9eac149d-12b1-4c91-b14b-8fd87341b572', 'ef370a46-03a6-4b1c-96fd-d0c7b8bf1c41', '3bc9057d-3de2-4778-84e6-1e9b393d4f27']
    ...
    content = f"This is the content of post {randint(1, 1000)}"
    is_visible = True
    is_offensive = False
    activity_id = choice(activity_ids)
    user_id = choice(user_ids)  # Randomly select a user_id from the provided list
...
# Main function to insert 1000 users and 1000 posts
def main():
    ...
    for _ in range(1000):
        ...
        cursor.execute("INSERT INTO \"public\".\"User\" (id, username, email, phone_number, picture, languages, gender, interest, affiliation, birth_year, user_type_id, user_location_id, notification_id, created_at, updated_at) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
               user_data)
        user_ids.append(user_data[0])  # Append user_id to the list
