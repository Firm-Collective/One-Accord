...
export const Messages = ({
  ...
  return (
    <>
      {posts?.map((post: Post) => (
        <div className="bg-white flex w-[369px] items-start gap-[10px] pl-[10px] pr-[46px] py-[4px] relative flex-[0_0_auto] rounded-[10px]" key={post.id}>
      ...
      <CommentSection frame="/frame-163422.svg" userPhoto='/Image-7.png' property1="default" refetch={refetch} returnVector='/ReturnVector.svg' />
    </>
  );
};
