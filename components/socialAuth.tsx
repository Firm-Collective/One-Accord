  ...
  return (
    <div>
      ...
      <div className='flex flex-col gap-2'>
        <Button variant='third' imageUrl='/google.svg' text={'Continue with Google'} type='submit' />
        <Button variant='third' imageUrl='/facebook.svg' text={'Continue with Facebook'} type='submit' />
        <Button variant='third' imageUrl='/apple.svg' text={'Continue with Apple'} type='submit' />
      </div>
