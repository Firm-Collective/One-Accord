...
const MapGL = () => {
  ...
  return (
    <div className='w-[100%] h-[281px]'>
     {isLoading ? (
        <div role="status" className="flex items-center justify-center h-full w-full bg-gray-300 rounded-lg animate-pulse dark:bg-gray-700">
        ...
        mapStyle='mapbox://styles/firmcollective/clwz4ftkv01bf01pp06wl1wl9'
