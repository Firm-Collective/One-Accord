    ...
    <div className='w-[100%] h-[281px]'>
      {isLoading ? (
        ...
        <ReactMapGL
          ...
          mapStyle={`https://api.mapbox.com/styles/v1/firmcollective/clwz4ftkv01bf01pp06wl1wl9?sdk=js-3.3.0&access_token=${process.env.NEXT_PUBLIC_MAPBOX_ACCESS_TOKEN}`}
