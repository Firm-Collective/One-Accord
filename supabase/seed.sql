...
VALUES 
    ...
    ('t458e7db-490b-49e4-a25e-25a6666fd30f', 'Tokyo', 'Japan', '35.6895', '139.6917');
...
VALUES 
    ('5d82cdd3-3c2f-47ff-a805-25e71519262q', true, true, false, '2024-04-26 10:00:00', 'email', 'In 5 minutes will start the activity prayer.'),
    ('b5901b2c-b39b-4b20-8465-0b7898b1592q', false, true, true, '2024-04-27 15:30:00', 'text', 'Activity worship will begin shortly.'),
    ('2a78e7db-490b-49e4-a25e-25a6666fd32q', true, true, true, '2024-04-28 09:45:00', 'both', 'Join us for the event Communion in 15 minutes.');
...
VALUES 
    ('94b2a736-d8c7-4722-8d64-86a0a24d4f80', 'user1', 'user1@example.com', '123456789', NULL, ARRAY['English'], 'Male', ARRAY['Interest1'], ARRAY['Affiliation1'], '1990-01-01', '53f8e720-1915-4dc8-a166-1226c5775330', '5d82cdd3-3f2f-47ff-a805-25e7151926d7', '5d82cdd3-3c2f-47ff-a805-25e71519262q', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
